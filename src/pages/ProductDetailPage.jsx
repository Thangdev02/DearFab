...
//   // Update selectedSize based on available sizes
//   useEffect(() => {
//     if (product) {
...
//         setSelectedSize(availableSizes[0]); // Set to first available size
//       }
//     }
...
//                 disabled={availableSizes.length === 0} // Disable if no sizes available
//               >
...
//                   style={{ padding: '5px' }}
//                   disabled={availableQuantity === 0} // Disable if no quantity available
//                 />
//               </Form.Group>
//               <Button
//                 variant="dark"
